...
@Service
@Primary
public class TransactionBasedRecommender implements ProductRecommender {
    private final RecommendationsRepository recommendationsRepository;


    public TransactionBasedRecommender(RecommendationsRepository recommendationsRepository) {
